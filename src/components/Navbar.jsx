...
const Navbar = () => {
  ...
  return (
    <header className="fixed w-full z-50 font-sans transition-all duration-300">
      ...
      {/* Main Navbar */}
      <nav className={`bg-white dark:bg-gray-900 border-b border-gray-200 dark:border-gray-800 shadow-sm transition-all duration-300 ${scrolled ? 'py-1' : 'py-2'}`}>
          ...
          <div className="flex justify-between items-center h-14">
            ...
            <Link to="/" className="flex-shrink-0 flex items-center group">
              ...
              <div className="ml-4 flex flex-col justify-center">
                ...
                <span className="text-xs uppercase tracking-[0.2em] text-gray-500 dark:text-gray-400 mt-1 font-bold">
                  Fort Abbas
                </span>
              </div>
            </Link>
            ...
            <div className="hidden lg:flex items-center space-x-6">
                ...
                if (link.name === 'Admissions') {
                  return (
                    <Link
                      key={link.name}
                      to={link.path}
                      className="relative inline-flex items-center gap-2 px-6 py-2.5 bg-primary-600 hover:bg-primary-700 text-white hover:!text-white font-bold text-sm uppercase tracking-wide rounded-full shadow-lg hover:shadow-xl transform hover:scale-105 transition-all duration-300 group overflow-hidden"
                    >
              ...
              <button
                onClick={toggleTheme}
                className="text-gray-500 hover:text-secondary-700 dark:text-gray-400 dark:hover:text-secondary-400 transition-colors"
              ...
              {user ? (
                <div className="relative">
                  <button
                    ...
                    className="flex items-center space-x-2 text-gray-700 dark:text-gray-200 hover:text-secondary-700 focus:outline-none"
                  >
            ...
            <div className="flex items-center lg:hidden space-x-4">
              ...
              <button
                ...
                className="text-gray-700 dark:text-gray-200 hover:text-secondary-700 focus:outline-none"
              >
