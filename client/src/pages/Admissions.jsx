...
const Admissions = () => {
  ...
  const handleFileUpload = (e, fieldName) => {
    ...
    if (file.size > 5 * 1024 * 1024) {
      setError(`${fieldName} file size should be less than 5MB`);
      return;
    }
    ...
    <div className="min-h-screen pt-24 pb-16 px-4 bg-gray-50 dark:bg-gray-900">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="text-center mb-16 animate-fade-in">
          <h1 className="text-5xl font-bold mb-4 gradient-text">Admissions</h1>
        ...
        {success && (
          <div className="mb-8 p-4 bg-green-50 dark:bg-green-900/20 border border-green-200 dark:border-green-800 rounded-lg flex items-center gap-3 text-green-700 dark:text-green-400 animate-fade-in">
        ...
        {error && (
          <div className="mb-8 p-4 bg-red-50 dark:bg-red-900/20 border border-red-200 dark:border-red-800 rounded-lg flex items-center gap-3 text-red-700 dark:text-red-400 animate-fade-in">
            <svg className="w-6 h-6 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        {/* Application Form */}
        <section className="mb-16 card animate-slide-in">
          <h2 className="text-3xl font-bold mb-8 text-gray-800 dark:text-gray-100">Apply Now</h2>
          
          <form onSubmit={handleSubmit} className="space-y-8">
            {/* Personal Information */}
            <div>
              <h3 className="text-xl font-semibold mb-4 text-gray-800 dark:text-gray-100">Personal Information</h3>
            ...
            {/* Address */}
            <div>
              <h3 className="text-xl font-semibold mb-4 text-gray-800 dark:text-gray-100">Address</h3>
              <div className="grid md:grid-cols-2 gap-6">
            ...
            {/* Academic Background */}
            <div>
              <h3 className="text-xl font-semibold mb-4 text-gray-800 dark:text-gray-100">Academic Background</h3>
              <div className="grid md:grid-cols-2 gap-6">
                <div className="md:col-span-2">
                  <label className="block text-sm font-semibold text-gray-700 dark:text-gray-300 mb-2">
            ...
            {/* Program Selection */}
            <div>
              <h3 className="text-xl font-semibold mb-4 text-gray-800 dark:text-gray-100">Program Selection</h3>
              <div className="grid md:grid-cols-2 gap-6">
                <div>
                  <label className="block text-sm font-semibold text-gray-700 dark:text-gray-300 mb-2">
            ...
            {/* Document Uploads */}
            <div>
              <h3 className="text-xl font-semibold mb-4 text-gray-800 dark:text-gray-100">Required Documents</h3>
        ...
        <section className="mb-16 animate-slide-in">
          <h2 className="text-3xl font-bold mb-8 text-gray-800 dark:text-gray-100">Admission Process</h2>
              ...
              <div key={item.step} className="flex gap-6 mb-8 last:mb-0">
                <div className="flex flex-col items-center">
                  ...
                  {index < process.length - 1 && (
                    <div className="w-0.5 h-16 bg-gradient-to-b from-primary-500 to-secondary-500 mt-2"></div>
                  )}
                </div>
            ...
            <div className="space-y-4">
              {importantDates.map((item, index) => (
                <div key={index} className="flex justify-between items-center border-b border-gray-200 dark:border-gray-700 pb-3 last:border-0">
                  ...
                  <span className="text-primary-600 dark:text-primary-400 font-medium">{item.date}</span>
                </div>
              ))}
            </div>
          </div>
        ...
        {/* Contact Section */}
        <section className="mt-16 card text-center animate-slide-in bg-gradient-to-r from-primary-50 to-secondary-50 dark:from-primary-900/20 dark:to-secondary-900/20">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <a href="mailto:xahidcodes@gmail.com" className="btn-primary">
              Email Us
            </a>
            <a href="tel:+923072280505" className="btn-secondary">
              Call:  (+92)307-2280505
            </a>
          </div>
        </section>
