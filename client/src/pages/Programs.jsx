        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
            {programs.map((program, index) => (
              <div
                key={program._id || program.courseId}
              ...
              >
                ...
                <p className="text-gray-600 dark:text-gray-400 mb-3 text-sm">
                  <span className="font-semibold">Course ID:</span> {program.courseId}
                </p>
                ...
                <div className="border-t border-gray-200 dark:border-gray-700 pt-3 mt-3 space-y-1.5">
                  ...
                  <div className="flex items-center gap-2 text-sm">
                    ...
                    <span className="text-gray-700 dark:text-gray-300">
                      <span className="font-semibold">Semesters:</span> {program.semesters || 'N/A'}
                    </span>
                  </div>
                </div>
